...
# plot survival curve
Plot_survival <- function(survDat, km, mainLabel, DeCAF_graph, individual, schemaList){
  pos = 96
  if(mainLabel == "CPTAC"){
    pos = 30
  }
...
# plot survival curve
Plot_survival_interaction <- function(survDat, km, mainLabel, DeCAF_graph,  individual, schemaList){
  pos = 96
  splots <- list()
  smodels <- list()
  # Elyada
...
## Load Survival
SurvDatCmb <- read.csv("../../data/public_PDAC_clean/combined_data/combined_survival_DeCAF.csv")
...
survival_figures <- Plot_survival(survDat, km, mainLabel = "Full Pooled Survival Data", DeCAF_graph = T,
...
pdf("../../results/figures/ElyadaCAF_PublicPDAC_Survival.pdf", onefile = F)
survival_figures[[1]][1]
dev.off()



pdf("../../results/figures/ScissorsCAF_PublicPDAC_Survival.pdf", onefile = F)
survival_figures[[1]][3]
dev.off()

pdf("../../results/figures/DeCAF_PublicPDAC_Survival.pdf", onefile = F)
survival_figures[[1]][4]
dev.off()


pdf("../../results/figures/Maurer_PublicPDAC_Survival.pdf", onefile = F)
...
survival_interaction_all = Plot_survival_interaction(survDat, km, mainLabel = "Full Pooled Survival Data", DeCAF_graph = TRUE, 
                                                     individual = FALSE, schemaList = schemaList)
