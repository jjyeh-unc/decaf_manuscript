...
tmpK <- 6
dataSet <- Call_consensus(dataSet, tmpSchema, sampSub, 2, tmpK, tmpRowScale, TRUE,FALSE, "km","euclidean", "R-4.X.X")
#tmpSubtypeLab <- c("Absent","iCAF","Mixed.iCAF","myCAF","Mixed.myCAF","Mixed","Absent","Absent","Mixed.myCAF") N=9
#tmpSubtypeLab <- c("Absent","iCAF","Mixed","iCAF","myCAF","myCAF","Mixed","Absent","Absent","Mixed.myCAF") N=10
#tmpSubtypeLab <- c("myCAF","iCAF","Mixed") 
tmpSubtypeLab <- c("myCAF","iCAF","Mixed.iCAF","myCAF","Mixed","Absent") 
dataSet <- Relabel_subtype(dataSet, tmpSubtypeLab, tmpSchema, tmpK, tmpRowScale)
